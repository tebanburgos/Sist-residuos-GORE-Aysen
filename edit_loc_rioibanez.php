...
<title>Río Ibáñez - Editar localización</title>
...
<body class="loggedin">
    ...
    <div class="mainwrapper">
        ...
        <div class="mainleft">
            ...
            <?php
		require_once('template/menu_rioibanez.php');
		?>
        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <div class="content">
                    ...
                    <br />
                    <form class="stdform" action="controlador/mod_loc_rioibanez.php" method="post" enctype="multipart/form-data" name="form1">
                        ...
                        <p class="stdformbutton">
                            ...
                            <input type="reset" class="reset radius2" onclick="location.href='loc_rioibanez.php'" value="Volver" />
                        </p>
