...
<title>Chile Chico - Editar localización</title>
        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <div class="content">
                    ...
                    <br />
                    <form class="stdform" action="controlador/mod_loc_chilechico.php" method="post" enctype="multipart/form-data" name="form1">
                        ...
                        <p class="stdformbutton">
                            ...
                            <input type="reset" class="reset radius2" onclick="location.href='loc_chilechico.php'" value="Volver" />
                        </p>
