...
<title>Cisnes - Resumen comunal</title>
        ...
        <div class="maincontent noright">
        	   <div class="maincontentinner">
                ...
                <ul class="maintabmenu multipletabmenu">
                    <li class="current"><a href="cisnes.php">Resumen comunal</a></li>
                    <li><a href="loc_cisnes.php">Localización</a></li>
                ...
                <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Resumen comunal - Cisnes</span></h2>
