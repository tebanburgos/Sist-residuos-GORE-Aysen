...
<title>Aysén - Resumen comunal</title>
        ...
        <div class="maincontent noright">
        	   <div class="maincontentinner">
                ...
                <ul class="maintabmenu multipletabmenu">
                    <li class="current"><a href="aysen.php">Resumen comunal</a></li>
                    <li><a href="loc_aysen.php">Localización</a></li>
                    <li><a href="info_aysen.php">Información</a></li>
                    
                </ul><!--maintabmenu-->
                
                <div class="content">
                <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Resumen comunal - Aysén</span></h2>
